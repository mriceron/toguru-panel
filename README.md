...
## Usage
Download last version (1.1.0) of toguru-panel [here](https://github.com/AutoScout24/toguru-panel/releases/download/1.1.0/toguru-panel.zip), configure it and run on webserver!
